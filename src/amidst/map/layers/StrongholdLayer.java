...
public class StrongholdLayer extends IconLayer
{
    ...
    private static final Biome[] biomes1_2 = { Biome.desert, Biome.forest, Biome.extremeHills, Biome.swampland, Biome.taiga, Biome.icePlains, Biome.iceMountains, Biome.desertHills, Biome.forestHills, Biome.extremeHillsEdge, Biome.jungle, Biome.jungleHills };
    ...
    public void findStrongholds()
    {
        ...
        if (MinecraftUtil.getVersion() == VersionInfo.V1_0)
        {
        ...
        if (MinecraftUtil.getVersion().isAtLeast(VersionInfo.V1_2_2))
        {
            validBiomes = biomes1_2;
        }
