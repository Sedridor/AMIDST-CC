    ...
    public static String[] readArguements(String eArgs)
    {
        ...
        while (matcher.find())
        {
            ...
            if (objectMatcher.find())
            {
                ...
                arg = arg.substring(0, Math.max(0, objectMatcher.end() - 1)) + replaceWith + arg.substring(Math.min(objectMatcher.end(), arg.length()));
