...
public class BiomeRandomizer
{
    ...
    public BiomeIncidences currentIncidences()
    {
        return incidences;
    }
    ...
    {
        this.incidences = (incidences.clone());
        nextIndex = 0;
    ...
    public class PickByClimate
    {
        public int biome(int climate, IntRandomizer source)
        {
            if (climate == 1)
            {
                return hot.choose(source).biomeID;
            }
            if (climate == 2)
            {
                return warm.choose(source).biomeID;
            }
            if (climate == 3)
            {
                return cool.choose(source).biomeID;
            }
            if (climate == 4)
            {
                return snowy.choose(source).biomeID;
            }
