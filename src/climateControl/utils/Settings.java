...
/**
 * This class permits a relatively type-safe facade for the Forge Configuration system to allow behind-the-scenes manipulations of the configurations; currently world-specific configs and change tracking; in the future access to a GUI system.
 * 
...
abstract public class Settings implements Streamable, ConfigReader
{
    ...
    protected class BooleanSetting extends Setting<Boolean>
    {
        ...
        public Property propertyFrom(Configuration source)
        {
            if (comment.equals(""))
            {
                return source.get(category.name, key, defaultValue);
            }
