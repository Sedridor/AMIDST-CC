...
public class TempleLayer extends IconLayer
{
    ...
    public List<Biome> getValidBiomes()
    {
        ...
        {
            validBiomes = new Biome[] { Biome.desert, Biome.desertHills, Biome.jungle, Biome.jungleHills, Biome.swampland };
        }
        else if (MinecraftUtil.getVersion().isAtLeast(VersionInfo.V1_3_1))
        {
            validBiomes = new Biome[] { Biome.desert, Biome.desertHills, Biome.jungle };
        }
        else
        {
