...
public class BiomeIncidences implements Cloneable
{
    ...
    public static final String mushroomIslandName = "Mushroom Island";
    ...
    public void readFrom(Configuration config)
    {
        ...
        mushroomIsland = config.get(biomeFrequencyCategory, mushroomIslandName, 10).getInt();
    }

    public int totalIncidences()
    {
        return birchForest + coldTaiga + desert + extremeHills + forest + icePlains + jungle + megaTaiga + mesaPlateau + mesaPlateau_F + plains + roofedForest + savanna + swampland + taiga;
    }
    ...
    /*
     * this.randomBiomeList = new BiomeGenBase[] {BiomeGenBase.desert, BiomeGenBase.desert, BiomeGenBase.savanna, BiomeGenBase.plains, BiomeGenBase.plains, BiomeGenBase.forest, BiomeGenBase.forest, BiomeGenBase.roofedForest, BiomeGenBase.extremeHills, BiomeGenBase.extremeHills, BiomeGenBase.birchForest, BiomeGenBase.swampland, BiomeGenBase.swampland, BiomeGenBase.taiga, BiomeGenBase.icePlains, BiomeGenBase.coldTaiga, BiomeGenBase.mesaPlateau, BiomeGenBase.mesaPlateau_F, BiomeGenBase.megaTaiga, BiomeGenBase.jungle, BiomeGenBase.jungle};
     */
