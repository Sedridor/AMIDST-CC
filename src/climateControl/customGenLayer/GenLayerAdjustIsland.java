...
public class GenLayerAdjustIsland extends GenLayerPack
{
    ...
    public GenLayerAdjustIsland(long par1, GenLayer par3GenLayer, int maxLandAdvance, int minSeaAdvance, int changeChances)
    {
        super(par1);
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                if (k3 == 0 && (up != 0 || left != 0 || right != 0 || down != 0))
                {
                    ...
                    if (up != 0)
                    {
                        this.initChunkSeed(j2 + par1, i2 + par2 + 1);
                    ...
                    if (left != 0)
                    {
                        this.initChunkSeed(j2 + par1 + 1, i2 + par2);
                        if (this.nextInt(changeChances) <= maxLandAdvance)
                        {
                            if (hits == 0)
                            {
                    ...
                    if (right != 0)
                    {
                        ...
                        this.initChunkSeed(j2 + par1 + 1, i2 + par2 + 1);
                        if (this.nextInt(changeChances) <= maxLandAdvance)
                        {
                            if (hits == 0)
                            {
