...
public class SpawnLayer extends IconLayer
{
    ...
    public static final ArrayList<Biome> validBiomes = new ArrayList<Biome>(Arrays.asList(Biome.forest, Biome.plains, Biome.taiga, Biome.taigaHills, Biome.forestHills, Biome.jungle, Biome.jungleHills));
    ...
    {
        if ((spawnObject.globalX >= frag.blockX) && (spawnObject.globalX < frag.blockX + Fragment.SIZE) && (spawnObject.globalY >= frag.blockY) && (spawnObject.globalY < frag.blockY + Fragment.SIZE))
        {
