...
/**
 * This is GenLayerAddIsland except that it doesn't automatically extend frozen zones into oceans. Oh, and it has a better name since the original doesn't actually add any islands, it add *to* existing land.
 * 
 * @author Zeno410
 */
