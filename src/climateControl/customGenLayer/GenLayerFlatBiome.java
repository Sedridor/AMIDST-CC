...
public class GenLayerFlatBiome extends GenLayerPack
{
    ...
    public GenLayerFlatBiome(long par1, GenLayer par3GenLayer)// , WorldType par4WorldType)
    {
        ...
        /*
         * if (par4WorldType == WorldType.DEFAULT_1_1) { this.field_151623_c = new BiomeGenBase[] {BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.extremeHills, BiomeGenBase.swampland, BiomeGenBase.plains, BiomeGenBase.taiga}; }
         */
    }
