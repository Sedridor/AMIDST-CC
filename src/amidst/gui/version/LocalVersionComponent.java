        ...
        (new Thread(new Runnable() {
            ...
            public void run()
            {
                try
                {
                    ...
                    IMinecraftInterface climateControlInterface = new ClimateControledGenerator(minecraftInterface.getVersion(), profile.getJarFile());
                    Util.setMinecraftInterfaces(minecraftInterface, climateControlInterface);
