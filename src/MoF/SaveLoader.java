...
//    public static Size biomeSize = Size.DEFAULT;
//
//    public enum Size
//    {
//        SIZE_1("1", (byte)1),
//        SIZE_2("2", (byte)2),
//        SIZE_3("3", (byte)3),
//        DEFAULT("4 (Default)", (byte)4),
//        SIZE_5("5", (byte)5),
//        SIZE_6("6 (Large Biomes)", (byte)6),
//        SIZE_7("7", (byte)7),
//        SIZE_8("8", (byte)8);
//
//        private final String name;
...
//        }
//
//        public static Size fromMixedCase(String name)
//        {
//            name = name.toLowerCase();
//            for (Size t : values())
//            {
//                if (t.name.toLowerCase().equals(name) || t.value == Byte.parseByte(name))
//                {
//                    return t;
//                }
//            }
//            Log.crash("Unable to find Biome Size: " + name);
//            return null;
//        }
//    }
            ...
            else
            {
                ...
                for (int i = 0; i < (listing != null ? listing.length : 0); i++)
                {
                    if (listing[i].isFile())
                    {
                        ...
                        addPlayer(listing[i].getName().split("\\.")[0], ((CompoundTag)playerInputStream.readTag()));
