...
public class ClimateControledGenerator implements IMinecraftInterface
{
    ...
    public void createWorld(long seed, String type, String generatorOptions)
    {
        ...
        biomeLayers = new StackedContinentsGenerator().stackedContinents(settings, worldSeed);
    }

    public void setWorldFile()
    {
        this.worldConfigFile = new File(CONFIG_FILE);
        ...
        if (!this.worldConfigFile.exists())
        {
            ...
            if (!this.worldConfigFile.exists())
            {
                logger.warning(worldConfigFile.getAbsolutePath() + " not found");
            }
        }
    }
    ...
    private GenLayer quarteredRiverMix()
    {
        ...
        /*
         * if (worldType.equals("LARGE_BIOMES")); { b0 = 6; }
         */
    ...
    private GenLayer stackedContinents()
    {
        ...
        for (int j = 0; j < b0; ++j)
        {
            forRareBiomes = new GenLayerZoom(1000 + j, forRareBiomes);
    ...
    private GenLayer mountains()
    {
        ...
        /*
         * GenLayer genlayerdeepocean = new GenLayerZoom(1000L, ridges(3)); GenLayer genlayer3 = new GenLayerAddIsland(5L,genlayerdeepocean); genlayer3 = new GenLayerFillLakes(6L,genlayer3); genlayer3 = new GenLayerOceanSmooth(3L,genlayer3);
         */
        ...
        GenLayerClimateSmooth genlayersmooth1 = new GenLayerClimateSmooth(1000L, object);
        GenLayerRiverMix genlayerrivermix = new GenLayerRiverMix(100L, genlayersmooth1, genlayersmooth);
        GenLayerVoronoiZoom genlayervoronoizoom = new GenLayerVoronoiZoom(10L, genlayerrivermix);
        genlayerrivermix.initWorldGenSeed(this.worldSeed);
        genlayervoronoizoom.initWorldGenSeed(this.worldSeed);
    ...
    private GenLayer ridges(int expansionRounds)
    {
        ...
        {
            genlayer = new GenLayerZoom(i + 100L, genlayer);
        }
