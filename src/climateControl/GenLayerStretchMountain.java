...
public class GenLayerStretchMountain extends GenLayer
{
    ...
    public static final boolean is(int tested)
    {
        return tested == 0;
    }

    public static final boolean isnt(int tested)
    {
        return tested > 0;
    }
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                if (is(k3) && (k2 != 0 || l2 != 0 || i3 != 0 || j3 != 0 || upleft != 0 || downleft != 0 || downright != 0 || upright != 0))
                {
                    int l3 = 1;
                    int i4 = 1;
                ...
                else if (k3 > 0 && (k2 == 0 || l2 == 0 || i3 == 0 || j3 == 0) || upleft == 0 || downleft == 0 || downright == 0 || upright == 0)
                {
                    int adjacencies = 0;
                    if (k2 != 0)
                    {
